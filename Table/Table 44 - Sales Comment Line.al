table 44 "Sales Comment Line"
{
    ...
    begin
        OnBeforeCopyComments(SalesCommentLine,ToDocumentType);
    ...
    local procedure OnBeforeCopyComments(var SalesCommentLine: Record "Sales Comment Line";ToDocumentType: Integer)
    begin
    end;
}
