table 37 "Sales Line"
{
    ...
    [IntegrationEvent(false, false)]
    local procedure OnUpdateUnitPriceOnBeforeFindPrice(SalesHeader: Record "Sales Header";var SalesLine: Record "Sales Line";CalledByFieldNo: Integer;FieldNo: Integer;var IsHandled: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnValidateNoOnBeforeInitRec(var SalesLine: Record "Sales Line";xSalesLine: Record "Sales Line";FieldNo: Integer)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnValidateNoOnBeforeUpdateDates(var SalesLine: Record "Sales Line";xSalesLine: Record "Sales Line";SalesHeader: Record "Sales Header";FieldNo: Integer)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnValidateVariantCodeOnAfterChecks(var SalesLine: Record "Sales Line";xSalesLine: Record "Sales Line";FieldNo: Integer)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeCalcPlannedDeliveryDate(SalesLine: Record "Sales Line";var PlannedDeliveryDate: Date;FieldNo: Integer;var IsHandled: Boolean)
    begin
    end;
