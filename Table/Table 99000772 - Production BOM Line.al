table 99000772 "Production BOM Line"
{
                ...
                case Type of
                  Type::Item:
                    begin
                      ...
                      if "No." <> xRec."No." then
                        "Variant Code" := '';
                      OnValidateNoOnAfterAssignItemFields(Rec,Item);
                    end;
                  Type::"Production BOM":
                    begin
                      ...
                      OnValidateNoOnAfterAssignProdBOMFields(Rec,ProdBOMHeader);
                    end;
                end;
            end;
        }
    ...
    [IntegrationEvent(false, false)]
    local procedure OnValidateNoOnAfterAssignProdBOMFields(var ProductionBOMLine: Record "Production BOM Line";ProductionBOMHeader: Record "Production BOM Header")
    begin
    end;
}
