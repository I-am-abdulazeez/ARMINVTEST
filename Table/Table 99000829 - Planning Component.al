table 99000829 "Planning Component"
{
    ...
    local procedure OnAfterCreateDimTableIDs(var PlanningComponent: Record "Planning Component";FieldNo: Integer;var TableID: array [10] of Integer;var No: array [10] of Code[20])
    begin
    end;
