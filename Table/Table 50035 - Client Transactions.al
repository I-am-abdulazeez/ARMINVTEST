table 50035 "Client Transactions"
{
    ...
    fields
    {
        ...
        {
            DataClassification = ToBeClassified;
            OptionCaption = 'Subscription,Redemption,Fee,Dividend';
            OptionMembers = Subscription,Redemption,Fee,Dividend;
        }
        ...
        {
            DataClassification = ToBeClassified;
            OptionCaption = 'Unit Transfer,Bank Transfer,Dividend ReInvestment,Ordinary Redemption,Dividend Payout,Bank Transaction,Account-to-Account Transfer,Dividend Declared';
            OptionMembers = "Unit Transfer","Bank Transfer","Dividend ReInvestment","Ordinary Redemption","Dividend Payout","Bank Transaction","Account-to-Account Transfer","Dividend Declared";
        }
        ...
        field(38;"Selected By";Text[50])
        {
            DataClassification = ToBeClassified;
        }
        field(39;"Dividend Paid";Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(40;"Penalty Charge";Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(41;"Reverse To Fund";Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(42;"Nominee Dividend";Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(43;"Portfolio Code";Code[20])
        {
            DataClassification = ToBeClassified;
        }
    }
