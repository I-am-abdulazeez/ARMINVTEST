table 2840 "Native - Gen. Settings Buffer"
{
    ...
    fields
    {
        ...
        field(51;"Defauilt Tax Description";Text[50])
        {
    ...
    var
        ...
        AlTelemetryCategoryTxt: Label 'AL NativeApi', Locked=true;
        EmptyCountryRegionErr: Label 'Country/Region code is not set.', Locked=true;
        FallbackCountryRegionFailedErr: Label 'Could not determine country/region from G/L Setup.', Locked=true;
    ...
    local procedure LoadCountryRegion()
    var
        CompanyInformation: Record "Company Information";
        GeneralLedgerSetup: Record "General Ledger Setup";
    begin
        ...
        SendTraceTag('00007HP',AlTelemetryCategoryTxt,VERBOSITY::Warning,EmptyCountryRegionErr,DATACLASSIFICATION::SystemMetadata);
        GeneralLedgerSetup.Get;
        case GeneralLedgerSetup."LCY Code" of
          'USD':
          ...
          'GBP':
            ...
            SendTraceTag(
              ...
              VERBOSITY::Error,
              FallbackCountryRegionFailedErr,
              DATACLASSIFICATION::SystemMetadata);
        end;
    end;
}
