table 5405 "Production Order"
{
    ...
    local procedure OnAfterCreateDimTableIDs(var ProductionOrder: Record "Production Order";FieldNo: Integer;var TableID: array [10] of Integer;var No: array [10] of Code[20])
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeAssignItemNo(var ProdOrder: Record "Production Order";xProdOrder: Record "Production Order";var Item: Record Item;FieldNo: Integer)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeAssignFamily(var ProdOrder: Record "Production Order";xProdOrder: Record "Production Order";var Family: Record Family;FieldNo: Integer)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeAssignSalesHeader(var ProdOrder: Record "Production Order";xProdOrder: Record "Production Order";var SalesHeader: Record "Sales Header";FieldNo: Integer)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeMultiLevelMessage(var IsHandled: Boolean)
    begin
    end;
}
