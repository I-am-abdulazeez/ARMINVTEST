table 469 "Workflow Webhook Subscription"
{
    ...
    var
        ConditionsCollection: DotNet JObject;
    begin
    ...
    [TryFunction]
    local procedure TryInitializeCollection(var ConditionsCollection: DotNet JObject)
    begin
    ...
    var
        ...
        RecRef: RecordRef;
        FieldRef: FieldRef;
        ConditionName: DotNet JObject;
        Condition: DotNet JObject;
        ConditionValue: DotNet JObject;
        FieldId: Integer;
        tableNo: Integer;
    begin
        // get source table id
