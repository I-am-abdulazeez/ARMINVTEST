table 336 "Tracking Specification"
{
    ...
    [Scope('Personalization')]
    procedure SetItemData(ItemNo: Code[20];ItemDescription: Text[50];LocationCode: Code[10];VariantCode: Code[10];BinCode: Code[20];QtyPerUoM: Decimal)
    begin
        "Item No." := ItemNo;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterInitFromTransLine(var TrackingSpecification: Record "Tracking Specification";TransferLine: Record "Transfer Line")
    begin
    end;
