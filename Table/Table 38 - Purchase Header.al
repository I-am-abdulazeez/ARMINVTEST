table 38 "Purchase Header"
{
    ...
    fields
    {
        ...
        field(2;"Buy-from Vendor No.";Code[20])
        {
            ...
            begin
                ...
                OnAfterCopyBuyFromVendorFieldsFromVendor(Rec,Vend);
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterCreateDimTableIDs(var PurchaseHeader: Record "Purchase Header";FieldNo: Integer;var TableID: array [10] of Integer;var No: array [10] of Code[20])
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterTransferExtendedTextForPurchaseLineRecreation(var PurchLine: Record "Purchase Line")
    begin
    end;

    [IntegrationEvent(TRUE, false)]
    procedure OnValidatePurchaseHeaderPayToVendorNo(Vendor: Record Vendor)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnValidateBuyFromVendorNoBeforeRecreateLines(var PurchaseHeader: Record "Purchase Header";FieldNo: Integer)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnValidatePaytoVendorNoBeforeRecreateLines(var PurchaseHeader: Record "Purchase Header";FieldNo: Integer)
    begin
    end;
}
