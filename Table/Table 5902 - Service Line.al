table 5902 "Service Line"
{
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterAssignItemValues(var ServiceLine: Record "Service Line";Item: Record Item;xServiceLine: Record "Service Line";FieldNo: Integer)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterAssignServItemValues(var ServiceLine: Record "Service Line";ServiceItem: Record "Service Item";ServiceItemComp: Record "Service Item Component")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterCreateDimTableIDs(var ServiceLine: Record "Service Line";FieldNo: Integer;var TableID: array [10] of Integer;var No: array [10] of Code[20])
    begin
    end;
