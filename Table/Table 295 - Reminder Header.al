table 295 "Reminder Header"
{
    ...
    local procedure OnAfterCreateDimTableIDs(var ReminderHeader: Record "Reminder Header";FieldNo: Integer;var TableID: array [10] of Integer;var No: array [10] of Code[20])
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeInsertBeginTexts(var ReminderHeader: Record "Reminder Header")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeInsertEndTexts(var ReminderHeader: Record "Reminder Header")
    begin
    end;
}
