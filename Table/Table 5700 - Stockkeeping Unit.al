table 5700 "Stockkeeping Unit"
{
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeValidateStandardCost(var StockkeepingUnit: Record "Stockkeeping Unit";xStockkeepingUnit: Record "Stockkeeping Unit";FieldNo: Integer;var IsHandled: Boolean)
    begin
    end;
}
