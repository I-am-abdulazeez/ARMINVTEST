table 50119 "Fund Transfer Lines"
{
    ...
    fields
    {
        ...
        field(45;"From Fund Code";Code[20])
        {
            ...
            begin
                ...
                "From Fund Name":=FundRec.Name;
                  if Type = Type::"Same Fund" then
                    "To Fund Code" := "From Fund Code";
                if Amount<>0 then
                Validate(Amount);
                end;
            end;
        ...
        field(135;"Header No";Code[20])
        {
            ...
            trigger OnValidate()
            begin
                // IF "Header No" <> xRec."Header No" THEN BEGIN
    ...
    begin
        FundTransferLines.Reset;
         FundTransferLines.SetCurrentKey("Line No");
          if FundTransferLines."Line No" = 0 then
          if FundTransferLines.FindLast then
             "Line No" := FundTransferLines."Line No" + 1
             else
             "Line No" := 1;
        ...
        //     NoSeriesMgt.InitSeries(FundAdministrationSetup."Fund Transfer Nos",xRec."No. Series",0D,"Header No","No. Series");
        //  END;
        //
        ...
        // "Created By":=USERID;
        // "Creation Date":=TODAY;
        // FundAdministration.InsertFundTransferTracker("Fund Transfer Status","Header No");
    end;
