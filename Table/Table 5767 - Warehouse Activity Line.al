table 5767 "Warehouse Activity Line"
{
    ...
    local procedure CheckIncreaseCapacity(DeductLineCapacity: Boolean)
    var
        BinContent: Record "Bin Content";
    ...
    local procedure UpdateBreakbulkQtytoHandle()
    var
        WhseActivLine: Record "Warehouse Activity Line";
    begin
    ...
    local procedure CheckReservedItemTrkg(CheckType: Option "Serial No.","Lot No.";ItemTrkgCode: Code[50])
    var
        Item: Record Item;
    ...
    local procedure InitTrackingSpecFromWhseActivLine(var TrackingSpecification: Record "Tracking Specification";var WhseActivityLine: Record "Warehouse Activity Line")
    begin
