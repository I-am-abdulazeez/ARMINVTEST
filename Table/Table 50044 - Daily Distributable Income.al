table 50044 "Daily Distributable Income"
{
    ...
    fields
    {
        ...
        field(21;"Quarter Closed";Boolean)
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(24;Source;Code[30])
        {
            DataClassification = ToBeClassified;
        }
        field(25;"Reversed Dividend";Decimal)
        {
            CalcFormula = Sum("Reversed Accrued Income"."Accrued Income" WHERE ("Redistribution Date"=FIELD(Date)));
            FieldClass = FlowField;
        }
        field(26;"Total Distributable Income";Decimal)
        {
            DataClassification = ToBeClassified;
            DecimalPlaces = 4:4;
        }
