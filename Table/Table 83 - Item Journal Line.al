table 83 "Item Journal Line"
{
    ...
    local procedure OnAfterSetupNewLine(var ItemJournalLine: Record "Item Journal Line";var LastItemJournalLine: Record "Item Journal Line")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterCreateDimTableIDs(var ItemJournalLine: Record "Item Journal Line";FieldNo: Integer;var TableID: array [10] of Integer;var No: array [10] of Code[20])
    begin
    end;
