table 1877 "VAT Setup Posting Groups"
{
    ...
    fields
    {
        ...
        field(18;"VAT Prod. Posting Grp Desc.";Text[50])
        {
    ...
    [Scope('Personalization')]
    procedure AddOrUpdateProdPostingGrp(ProdGrpCode: Code[20];GrpDesc: Text[50];VatRate: Decimal;SalesAccount: Code[20];PurchAccount: Code[20];IsService: Boolean;IsDefault: Boolean): Boolean
    var
