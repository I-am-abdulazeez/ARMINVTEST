table 5407 "Prod. Order Component"
{
    ...
    begin
        ...
        if Status in [Status::Released,Status::Finished] then
          CalcFields("Act. Consumption (Qty)");
        "Remaining Quantity" :=
          "Expected Quantity" - "Act. Consumption (Qty)";
        "Remaining Qty. (Base)" :=
          Round("Remaining Quantity" * "Qty. per Unit of Measure",0.00001);
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterCreateDimTableIDs(var ProdOrderComponent: Record "Prod. Order Component";FieldNo: Integer;var TableID: array [10] of Integer;var No: array [10] of Code[20])
    begin
    end;
