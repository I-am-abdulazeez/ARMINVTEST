table 302 "Finance Charge Memo Header"
{
    ...
    local procedure OnAfterCreateDimTableIDs(var FinanceChargeMemoHeader: Record "Finance Charge Memo Header";FieldNo: Integer;var TableID: array [10] of Integer;var No: array [10] of Code[20])
    begin
    end;
