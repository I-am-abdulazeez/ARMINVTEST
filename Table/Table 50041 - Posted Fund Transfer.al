table 50041 "Posted Fund Transfer"
{
    ...
    fields
    {
        ...
        field(116;"Sent to treasury";Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(117;"Date Sent to Treasury";Date)
        {
            DataClassification = ToBeClassified;
        }
        field(118;"Time Sent to Treasury";Time)
        {
            DataClassification = ToBeClassified;
        }
        field(119;"Processed By Bank";Boolean)
        {
            DataClassification = ToBeClassified;
            Editable = false;
        }
        field(120;"Date Processed By Bank";Date)
        {
            DataClassification = ToBeClassified;
            Editable = false;
        }
        field(121;"Time Processed By Bank";Time)
        {
            DataClassification = ToBeClassified;
            Editable = false;
        }
        field(122;"Payment Status";Text[50])
        {
            DataClassification = ToBeClassified;
        }
        field(123;"Payment Description";Text[150])
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(130;"Accrued Dividend Paid";Decimal)
        {
            CalcFormula = Sum("Daily Income Distrib Lines"."Income accrued" WHERE ("Transaction No"=FIELD(No),
                                                                                   "Fully Paid"=CONST(true),
                                                                                   "Account No"=FIELD("From Account No")));
            DecimalPlaces = 2:4;
            Editable = false;
            FieldClass = FlowField;
        }
        field(131;"Treasury Batch";Code[10])
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(135;"Quarter Filter";Code[20])
        {
        ...
        field(136;"Reason For Rejection";Option)
        {
            DataClassification = ToBeClassified;
