table 50058 "Subscription Schedules Header"
{
    ...
    fields
    {
        field(1;"Schedule No";Code[20])
        {
            ...
            begin
                if "Schedule No" <> xRec."Schedule No" then begin
                  ...
                  NoSeriesManagement.TestManual(FundAdministrationSetup."Subscription Schedule Nos");
                   "No. Series" := '';
                end;
            end;
        }
        ...
        {
            CalcFormula = Sum("Subscription Schedule Lines"."Total Amount" WHERE ("Schedule Header"=FIELD("Schedule No")));
            DecimalPlaces = 4:4;
            Editable = false;
        ...
        field(84;Comment;Text[150])
        {
            DataClassification = ToBeClassified;
        }
        field(85;"Bank Code";Code[30])
        {
            DataClassification = ToBeClassified;
            TableRelation = Bank;
        }
