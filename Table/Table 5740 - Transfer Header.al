table 5740 "Transfer Header"
{
    ...
    var
        ...
        UpdateTransferFromCodeQst: Label 'If you change the transfer-from location, the transfer order lines will be deleted.\\Do you want to continue?';
    ...
    local procedure UpdateTransLines(TransferHeader: Record "Transfer Header";FieldID: Integer)
    var
