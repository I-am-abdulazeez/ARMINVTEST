table 50079 "Redemption Recon header"
{
        ...
        field(1;No;Code[20])
        {
            ...
            begin
                if No <> xRec.No then begin
                    ...
                    NoSeriesMgt.TestManual(FundAdministrationSetup."Redemption Recon Nos");
                     "No. Series" := '';
                  end;
            end;
        }
    ...
    begin
           if No = '' then begin
               FundAdministrationSetup.Get;
               FundAdministrationSetup.TestField(FundAdministrationSetup."Redemption Recon Nos");
               NoSeriesMgt.InitSeries(FundAdministrationSetup."Redemption Recon Nos",xRec."No. Series",0D,No,"No. Series");
            end;
