table 39 "Purchase Line"
{
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeBlanketOrderLookup(var PurchaseLine: Record "Purchase Line";FieldNo: Integer;var IsHandled: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnUpdateDirectUnitCostOnBeforeFindPrice(PurchaseHeader: Record "Purchase Header";var PurchaseLine: Record "Purchase Line";CalledByFieldNo: Integer;FieldNo: Integer;var IsHandled: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnValidateNoOnAfterChecks(var PurchaseLine: Record "Purchase Line";xPurchaseLine: Record "Purchase Line";FieldNo: Integer)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnValidateNoOnBeforeInitRec(var PurchaseLine: Record "Purchase Line";xPurchaseLine: Record "Purchase Line";FieldNo: Integer)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnValidateQtyToReceiveOnAfterCheck(var PurchaseLine: Record "Purchase Line";FieldNo: Integer)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnValidateQuantityOnBeforeDropShptCheck(var PurchaseLine: Record "Purchase Line";xPurchaseLine: Record "Purchase Line";FieldNo: Integer;var IsHandled: Boolean)
    begin
    end;
