report 50058 "Settled Repayment Schedule"
{
    // version THL-LOAN-1.0.0

    DefaultLayout = RDLC;
    RDLCLayout = './Settled Repayment Schedule.rdlc';

    dataset
    {
        dataitem("Loan Application";"Historical Loans")
        {
            ...
            dataitem("Loan Repayment Schedule";"Historical Repayment Schedules")
            {
