report 5690 "Index Fixed Assets"
{
    ...
    procedure InitializeRequest(DeprBookCodeFrom: Code[10];IndexFigureFrom: Decimal;FAPostingDateFrom: Date;PostingDateFrom: Date;DocumentNoFrom: Code[20];PostingDescriptionFrom: Text[50];BalAccountFrom: Boolean)
    begin
