report 2501 "Day Book Cust. Ledger Entry"
{
    ...
    dataset
    {
        ...
        dataitem(Date;Date)
        {
            ...
            column(Cust__Ledger_Entry__TABLENAME__________CustLedgFilter;"Cust. Ledger Entry".TableName + ': ' + CustLedgFilter)
            {
            }
            column(CustLedgFilter;CustLedgFilter)
            {
            }
            column(Total_for______Cust__Ledger_Entry__TABLENAME__________CustLedgFilter;StrSubstNo(TotalForCustLedgerEntryLbl,"Cust. Ledger Entry".TableName,CustLedgFilter))
            {
            }
            ...
            dataitem("Cust. Ledger Entry";"Cust. Ledger Entry")
            {
                ...
                column(Cust__Ledger_Entry__FIELDNAME__Posting_Date__________FORMAT_Date__Period_Start__0_4_;FieldName("Posting Date") + ' ' + Format(Date."Period Start",0,4))
                {
                }
                column(FIELDNAME__Document_Type___________FORMAT__Document_Type__;FieldName("Document Type") + ' ' + Format("Document Type"))
                {
                }
                ...
                column(Total_for___FIELDNAME__Document_Type_________FORMAT__Document_Type__;StrSubstNo(TotalForCustLedgerEntryLbl,FieldName("Document Type"),Format("Document Type")))
                {
                }
