report 2502 "Day Book Vendor Ledger Entry"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Day Book Vendor Ledger Entry.rdlc';
    ...
    dataset
    {
        ...
        dataitem(Date;Date)
        {
            ...
            column(All_amounts_are_in___GLSetup__LCY_Code_;'All amounts are in ' + GLSetup."LCY Code")
            {
            }
            column(Vendor_Ledger_Entry__TABLENAME__________VendLedgFilter;"Vendor Ledger Entry".TableName + ': ' + VendLedgFilter)
            {
            }
            ...
            column(Total_for______Vendor_Ledger_Entry__TABLENAME__________VendLedgFilter;'Total for ' + "Vendor Ledger Entry".TableName + ': ' + VendLedgFilter)
            {
            }
            ...
            {
                DataItemTableView = SORTING("Document Type","Vendor No.","Posting Date","Currency Code");
                column(Vendor_Ledger_Entry__FIELDNAME__Posting_Date__________FORMAT_Date__Period_Start__0_4_;FieldName("Posting Date") + ' ' + Format(Date."Period Start",0,4))
                {
                }
                column(FIELDNAME__Document_Type___________FORMAT___Document_Type__;FieldName("Document Type") + ' ' + Format("Document Type"))
                {
                }
                ...
                column(Total_for___FIELDNAME__Document_Type_________FORMAT__Document_Type__;'Total for ' + FieldName("Document Type") + ' ' + Format("Document Type"))
                {
                }
                ...
                column(Total_for_____FORMAT_Date__Period_Start__0_4_;'Total for ' + Format(Date."Period Start",0,4))
                {
                }
