    ...
    dataset
    {
        dataitem(Vendor;Vendor)
        {
            ...
            dataitem("Purchase Line";"Purchase Line")
            {
                ...
                begin
                    CurrReport.CreateTotals(PurchOrderAmount,PurchOrderAmountLCY,PurchAmtOnOrder,PurchAmtOnOrderLCY);
                end;
            }
            ...
            trigger OnPreDataItem()
            begin
                CurrReport.CreateTotals(PurchOrderAmountLCY,PurchAmtOnOrderLCY);
            end;
        }
    }
