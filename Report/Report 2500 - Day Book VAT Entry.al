report 2500 "Day Book VAT Entry"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Day Book VAT Entry.rdlc';
    ...
    dataset
    {
        ...
        dataitem(Date;Date)
        {
            ...
            column(Total_for______VAT_Entry__TABLENAME__________VATEntryFilter;StrSubstNo(Text003Lbl,"VAT Entry".TableName,VATEntryFilter))
            {
            }
            ...
            column(Total_for______VAT_Entry__TABLENAME__________VATEntryFilter_Control52;StrSubstNo(Text003Lbl,"VAT Entry".TableName,VATEntryFilter))
            {
            }
            ...
            dataitem("Integer";"Integer")
            {
                ...
                column(VAT_Entry__FIELDNAME__Posting_Date__________FORMAT_Date__Period_Start__0_4_;"VAT Entry".FieldName("Posting Date") + ' ' + Format(Date."Period Start",0,4))
                {
                }
                ...
                dataitem("VAT Entry";"VAT Entry")
                {
                    ...
                    column(FIELDNAME_Type__________FORMAT_Type_;FieldName(Type) + ' ' + Format(Type))
                    {
                    }
                    ...
                    column(Total_for___FIELDNAME_Type________FORMAT_Type_;StrSubstNo(Text001Lbl,FieldName(Type),Format(Type)))
                    {
                    }
                    ...
                    column(Total_for___FIELDNAME_Type________FORMAT_Type__Control27;StrSubstNo(Text001Lbl,FieldName(Type),Format(Type)))
                    {
                    }
                    ...
                    begin
                        ...
                        CurrReport.CreateTotals(Base,Amount,
                          "Additional-Currency Amount","Additional-Currency Base");
                        FilterGroup(0);
                    end;
                }
                ...
                begin
                    SetRange(Number,0,3);
                    CurrReport.CreateTotals("VAT Entry".Base,"VAT Entry".Amount,
                      "VAT Entry"."Additional-Currency Amount","VAT Entry"."Additional-Currency Base");
