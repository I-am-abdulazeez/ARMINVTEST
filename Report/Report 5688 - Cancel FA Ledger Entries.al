report 5688 "Cancel FA Ledger Entries"
{
    ...
    procedure InitializeRequest(DeprBookCodeFrom: Code[10];StartingDateFrom: Date;EndingDateFrom: Date;UseNewPostingDateFrom: Boolean;NewPostingDateFrom: Date;DocumentNoFrom: Code[20];PostingDescriptionFrom: Text[50];BalAccountFrom: Boolean)
    begin
