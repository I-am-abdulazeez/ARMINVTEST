        ...
        dataitem("Job Register";"Job Register")
        {
            ...
            dataitem("Job Ledger Entry";"Job Ledger Entry")
            {
                ...
                begin
                    ...
                    CurrReport.CreateTotals("Total Cost (LCY)","Line Amount (LCY)");
                end;
            }

            trigger OnPreDataItem()
            begin
                CurrReport.CreateTotals("Job Ledger Entry"."Total Cost (LCY)","Job Ledger Entry"."Line Amount (LCY)");
            end;
        }
    }
