report 50107 "Active Loans 2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Active Loans 2.rdlc';

    dataset
    {
        dataitem("Loan Application";"Loan Application")
        {
            DataItemTableView = WHERE(Status=FILTER(<>"Fully Repaid"),Disbursed=CONST(true));
            column(LoanNo_LoanApplication;"Loan Application"."Loan No.")
            {
            }
            column(ClientName_LoanApplication;"Loan Application"."Client Name")
            {
            }
