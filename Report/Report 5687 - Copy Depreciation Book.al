report 5687 "Copy Depreciation Book"
{
    ...
    procedure InitializeRequest(DeprBookCodeFrom: Code[10];DeprBookCode2From: Code[10];StartingDateFrom: Date;EndingDateFrom: Date;DocumentNoFrom: Code[20];PostingDescriptionFrom: Text[50];BalAccountFrom: Boolean)
    begin
