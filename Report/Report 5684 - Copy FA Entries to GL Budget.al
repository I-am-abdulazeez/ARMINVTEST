report 5684 "Copy FA Entries to G/L Budget"
{
    ...
    [Scope('Personalization')]
    procedure InitializeRequest(NewDeprBookCode: Code[10];NewBudgetNameCode: Code[10];NewStartingDate: Date;NewEndingDate: Date;NewPostingDescription: Text[50];NewBalAccount: Boolean)
    begin
