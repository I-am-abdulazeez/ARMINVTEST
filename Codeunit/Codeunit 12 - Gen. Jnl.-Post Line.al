codeunit 12 "Gen. Jnl.-Post Line"
{
    ...
    var
        [SecurityFiltering(SecurityFilter::Ignored)]GLEntry: Record "G/L Entry";
    begin
        GLEntry.LockTable;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeContinuePosting(var GenJournalLine: Record "Gen. Journal Line")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeApplyCustLedgEntry(var NewCVLedgEntryBuf: Record "CV Ledger Entry Buffer";var DtldCVLedgEntryBuf: Record "Detailed CV Ledg. Entry Buffer";var GenJnlLine: Record "Gen. Journal Line";Cust: Record Customer)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeApplyVendLedgEntry(var NewCVLedgEntryBuf: Record "CV Ledger Entry Buffer";var DtldCVLedgEntryBuf: Record "Detailed CV Ledg. Entry Buffer";var GenJnlLine: Record "Gen. Journal Line";Vend: Record Vendor)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterGLFinishPosting(GLEntry: Record "G/L Entry";var GenJnlLine: Record "Gen. Journal Line";IsTransactionConsistent: Boolean;FirstTransactionNo: Integer)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnCalcPmtDiscIfAdjVATCopyFields(var DetailedCVLedgEntryBuffer: Record "Detailed CV Ledg. Entry Buffer";CVLedgerEntryBuffer: Record "CV Ledger Entry Buffer")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeCreateGLEntriesForTotalAmountsUnapply(DetailedCustLedgEntry: Record "Detailed Cust. Ledg. Entry";var CustomerPostingGroup: Record "Customer Posting Group")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeInitGLEntryVATCopy(GenJnlLine: Record "Gen. Journal Line";var GLEntry: Record "G/L Entry")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnPostDtldCVLedgEntryOnBeforeCreateGLEntryGainLoss(var GenJournalLine: Record "Gen. Journal Line";DtldCVLedgEntryBuffer: Record "Detailed CV Ledg. Entry Buffer";var Unapply: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnCustUnrealizedVATOnBeforeInitGLEntryVAT(var GenJournalLine: Record "Gen. Journal Line";var VATEntry: Record "VAT Entry";var VATAmount: Decimal;var VATBase: Decimal;var VATAmountAddCurr: Decimal;var VATBaseAddCurr: Decimal)
    begin
    end;
