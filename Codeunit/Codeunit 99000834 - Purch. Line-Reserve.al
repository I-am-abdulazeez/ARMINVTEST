codeunit 99000834 "Purch. Line-Reserve"
{
    ...
    procedure CreateReservation(var PurchLine: Record "Purchase Line";Description: Text[50];ExpectedReceiptDate: Date;Quantity: Decimal;QuantityBase: Decimal;ForSerialNo: Code[50];ForLotNo: Code[50])
    var
        ShipmentDate: Date;
        SignFactor: Integer;
    begin
