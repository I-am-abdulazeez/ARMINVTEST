codeunit 6702 "O365 Contact Sync. Helper"
{
    ...
    [TryFunction]
    local procedure IsCompanyNameUnique(ExchangeContactCompanyName: Text[50])
    var
    ...
    local procedure ValidateCompanyName(var NavContact: Record Contact;ExchangeContactCompanyName: Text[50])
    var
        LocalContact: Record Contact;
    begin
        LocalContact.SetRange("Company Name",ExchangeContactCompanyName);
