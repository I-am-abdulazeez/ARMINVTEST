codeunit 5940 ServContractManagement
{
    ...
    begin
        ...
        OnAfterCreateInvoice(ServiceContractHeader);
    end;
    ...
    local procedure CreateDescriptionServiceLines(ServContractLineItemNo: Code[20];ServContractLineDesc: Text[50])
    var
    ...
    local procedure InsertDescriptionServiceLine(Description: Text[50])
    begin
        ServLine.Init;
    ...
    local procedure OnAfterCreateInvoice(var ServiceContractHeader: Record "Service Contract Header")
    begin
    end;
