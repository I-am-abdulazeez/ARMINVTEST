codeunit 5763 "Whse.-Post Shipment"
{
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterFindWhseShptLineForPurchLine(var WarehouseShipmentLine: Record "Warehouse Shipment Line";PurchaseLine: Record "Purchase Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterFindWhseShptLineForTransLine(var WarehouseShipmentLine: Record "Warehouse Shipment Line";TransferLine: Record "Transfer Line")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforePostSourceDocument(var WhseShptLine: Record "Warehouse Shipment Line";PurchaseHeader: Record "Purchase Header";SalesHeader: Record "Sales Header";TransferHeader: Record "Transfer Header")
    begin
    end;
