codeunit 13 "Gen. Jnl.-Post Batch"
{
    ...
    var
        ...
        ConfirmPostingAfterCurrentPeriodQst: Label 'The posting date of one or more journal lines is after the current fiscal year. Do you want to continue?';
    ...
    local procedure UpdateRecurringAmt(var GenJnlLine2: Record "Gen. Journal Line")
    begin
        with GenJnlLine2 do begin
          if ("Account No." <> '') and
             ("Recurring Method" in
    ...
    local procedure UpdateGenJnlLineWithVATInfo(var GenJournalLineFiltersSource: Record "Gen. Journal Line";GenJournalLineVATInfoSource: Record "Gen. Journal Line";StartLineNo: Integer;LastLineNo: Integer)
    var
    ...
    begin
        ...
        UpdateRecurringAmt(GenJournalLineToUpdate);
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeIfCheckBalance(GenJnlTemplate: Record "Gen. Journal Template";GenJnlLine: Record "Gen. Journal Line";LastDocType: Option;LastDocNo: Code[20];LastDate: Date;var CheckIfBalance: Boolean;CommitIsSuppressed: Boolean)
    begin
    end;
