codeunit 7000 "Sales Price Calc. Mgt."
{
    ...
    local procedure OnAfterCalcBestUnitPriceAsItemUnitPrice(var SalesPrice: Record "Sales Price";Item: Record Item)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterFindItemJnlLinePrice(var ItemJournalLine: Record "Item Journal Line";SalesPrice: Record "Sales Price";CalledByFieldNo: Integer)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterFindStdItemJnlLinePrice(var StdItemJnlLine: Record "Standard Item Journal Line";SalesPrice: Record "Sales Price";CalledByFieldNo: Integer)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterFindSalesLinePrice(var SalesLine: Record "Sales Line";SalesHeader: Record "Sales Header";var SalesPrice: Record "Sales Price";ResourcePrice: Record "Resource Price";CalledByFieldNo: Integer)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterFindSalesLineLineDisc(var SalesLine: Record "Sales Line";SalesHeader: Record "Sales Header";var SalesLineDiscount: Record "Sales Line Discount")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterFindSalesPrice(var ToSalesPrice: Record "Sales Price";FromSalesPrice: Record "Sales Price";QtyPerUOM: Decimal;Qty: Decimal;CustNo: Code[20];ContNo: Code[20];CustPriceGrCode: Code[10];CampaignNo: Code[20];ItemNo: Code[20];VariantCode: Code[10];UOM: Code[10];CurrencyCode: Code[10];StartingDate: Date;ShowAll: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterFindServLinePrice(var ServiceLine: Record "Service Line";ServiceHeader: Record "Service Header";SalesPrice: Record "Sales Price";ResourcePrice: Record "Resource Price";ServiceCost: Record "Service Cost";CalledByFieldNo: Integer)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterFindServLineDisc(var ServiceLine: Record "Service Line";ServiceHeader: Record "Service Header";SalesLineDiscount: Record "Sales Line Discount")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterGetSalesLinePrice(SalesHeader: Record "Sales Header";var SalesLine: Record "Sales Line";var TempSalesPrice: Record "Sales Price" temporary)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeGetSalesLineLineDisc(SalesHeader: Record "Sales Header";var SalesLine: Record "Sales Line")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnGetCustNoForSalesHeader(SalesHeader: Record "Sales Header";var CustomerNo: Code[20])
    begin
    end;
