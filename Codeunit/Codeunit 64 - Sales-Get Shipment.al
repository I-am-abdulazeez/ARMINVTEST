codeunit 64 "Sales-Get Shipment"
{
    ...
    [Scope('Personalization')]
    procedure GetItemChargeAssgnt(var SalesShptLine: Record "Sales Shipment Line";QtyToInv: Decimal)
    var
          ...
          if ItemChargeAssgntSales.FindSet then
            repeat
              if ItemChargeAssgntSales."Qty. to Assign" <> 0 then begin
                ...
                ItemChargeAssgntSales2."Qty. to Assign" := Round(QtyFactor * ItemChargeAssgntSales2."Qty. to Assign",0.00001);
