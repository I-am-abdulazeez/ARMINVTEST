codeunit 365 "Format Address"
{
    ...
    local procedure GenerateCustomPostCodeCity(var PostCodeCityText: Text[90];City: Text[50];PostCode: Code[20];County: Text[50];Country: Record "Country/Region")
    var
        CustomAddressFormat: Record "Custom Address Format";
    ...
    [Scope('Personalization')]
    procedure GetCompanyAddr(RespCenterCode: Code[10];var ResponsibilityCenter: Record "Responsibility Center";var CompanyInfo: Record "Company Information";var CompanyAddr: array [8] of Text[90])
    begin
    ...
    [Scope('Personalization')]
    procedure Company(var AddrArray: array [8] of Text[90];var CompanyInfo: Record "Company Information")
    begin
        with CompanyInfo do
          FormatAddr(
    ...
    [Scope('Personalization')]
    procedure Customer(var AddrArray: array [8] of Text[90];var Cust: Record Customer)
    var
        Handled: Boolean;
    begin
    ...
    [Scope('Personalization')]
    procedure Vendor(var AddrArray: array [8] of Text[90];var Vend: Record Vendor)
    var
        Handled: Boolean;
    begin
    ...
    [Scope('Personalization')]
    procedure BankAcc(var AddrArray: array [8] of Text[90];var BankAcc: Record "Bank Account")
    begin
        with BankAcc do
          FormatAddr(
            AddrArray,Name,"Name 2",Contact,Address,"Address 2",
    ...
    [Scope('Personalization')]
    procedure SalesHeaderSellTo(var AddrArray: array [8] of Text[90];var SalesHeader: Record "Sales Header")
    begin
        with SalesHeader do
          FormatAddr(
    ...
    [Scope('Personalization')]
    procedure SalesHeaderBillTo(var AddrArray: array [8] of Text[90];var SalesHeader: Record "Sales Header")
    var
        Handled: Boolean;
    begin
    ...
    [Scope('Personalization')]
    procedure SalesHeaderShipTo(var AddrArray: array [8] of Text[90];CustAddr: array [8] of Text[90];var SalesHeader: Record "Sales Header"): Boolean
    var
    ...
    [Scope('Personalization')]
    procedure PurchHeaderBuyFrom(var AddrArray: array [8] of Text[90];var PurchHeader: Record "Purchase Header")
    begin
        with PurchHeader do
          FormatAddr(
    ...
    [Scope('Personalization')]
    procedure PurchHeaderPayTo(var AddrArray: array [8] of Text[90];var PurchHeader: Record "Purchase Header")
    begin
        with PurchHeader do
          FormatAddr(
    ...
    [Scope('Personalization')]
    procedure PurchHeaderShipTo(var AddrArray: array [8] of Text[90];var PurchHeader: Record "Purchase Header")
    begin
        with PurchHeader do
          FormatAddr(
            AddrArray,"Ship-to Name","Ship-to Name 2","Ship-to Contact","Ship-to Address","Ship-to Address 2",
    ...
    [Scope('Personalization')]
    procedure SalesShptSellTo(var AddrArray: array [8] of Text[90];var SalesShptHeader: Record "Sales Shipment Header")
    begin
    ...
    [Scope('Personalization')]
    procedure SalesShptBillTo(var AddrArray: array [8] of Text[90];ShipToAddr: array [8] of Text[90];var SalesShptHeader: Record "Sales Shipment Header"): Boolean
    begin
    ...
    [Scope('Personalization')]
    procedure SalesShptShipTo(var AddrArray: array [8] of Text[90];var SalesShptHeader: Record "Sales Shipment Header")
    begin
        with SalesShptHeader do
          FormatAddr(
            AddrArray,"Ship-to Name","Ship-to Name 2","Ship-to Contact","Ship-to Address","Ship-to Address 2",
    ...
    [Scope('Personalization')]
    procedure SalesInvSellTo(var AddrArray: array [8] of Text[90];var SalesInvHeader: Record "Sales Invoice Header")
    begin
    ...
    [Scope('Personalization')]
    procedure SalesInvBillTo(var AddrArray: array [8] of Text[90];var SalesInvHeader: Record "Sales Invoice Header")
    var
        Handled: Boolean;
    begin
    ...
    [Scope('Personalization')]
    procedure SalesInvShipTo(var AddrArray: array [8] of Text[90];CustAddr: array [8] of Text[90];var SalesInvHeader: Record "Sales Invoice Header"): Boolean
    begin
    ...
    [Scope('Personalization')]
    procedure SalesCrMemoSellTo(var AddrArray: array [8] of Text[90];var SalesCrMemoHeader: Record "Sales Cr.Memo Header")
    begin
    ...
    [Scope('Personalization')]
    procedure SalesCrMemoBillTo(var AddrArray: array [8] of Text[90];var SalesCrMemoHeader: Record "Sales Cr.Memo Header")
    var
        Handled: Boolean;
    begin
    ...
    [Scope('Personalization')]
    procedure SalesCrMemoShipTo(var AddrArray: array [8] of Text[90];CustAddr: array [8] of Text[90];var SalesCrMemoHeader: Record "Sales Cr.Memo Header"): Boolean
    begin
    ...
    [Scope('Personalization')]
    procedure SalesRcptSellTo(var AddrArray: array [8] of Text[90];var ReturnRcptHeader: Record "Return Receipt Header")
    begin
    ...
    [Scope('Personalization')]
    procedure SalesRcptBillTo(var AddrArray: array [8] of Text[90];ShipToAddr: array [8] of Text[90];var ReturnRcptHeader: Record "Return Receipt Header"): Boolean
    begin
    ...
    [Scope('Personalization')]
    procedure SalesRcptShipTo(var AddrArray: array [8] of Text[90];var ReturnRcptHeader: Record "Return Receipt Header")
    begin
        with ReturnRcptHeader do
          FormatAddr(
            AddrArray,"Ship-to Name","Ship-to Name 2","Ship-to Contact","Ship-to Address","Ship-to Address 2",
    ...
    [Scope('Personalization')]
    procedure PurchRcptBuyFrom(var AddrArray: array [8] of Text[90];var PurchRcptHeader: Record "Purch. Rcpt. Header")
    begin
    ...
    [Scope('Personalization')]
    procedure PurchRcptPayTo(var AddrArray: array [8] of Text[90];var PurchRcptHeader: Record "Purch. Rcpt. Header")
    begin
        with PurchRcptHeader do
          FormatAddr(
            AddrArray,"Pay-to Name","Pay-to Name 2","Pay-to Contact","Pay-to Address","Pay-to Address 2",
    ...
    [Scope('Personalization')]
    procedure PurchRcptShipTo(var AddrArray: array [8] of Text[90];var PurchRcptHeader: Record "Purch. Rcpt. Header")
    begin
        with PurchRcptHeader do
          FormatAddr(
            AddrArray,"Ship-to Name","Ship-to Name 2","Ship-to Contact","Ship-to Address","Ship-to Address 2",
    ...
    [Scope('Personalization')]
    procedure PurchInvBuyFrom(var AddrArray: array [8] of Text[90];var PurchInvHeader: Record "Purch. Inv. Header")
    begin
    ...
    [Scope('Personalization')]
    procedure PurchInvPayTo(var AddrArray: array [8] of Text[90];var PurchInvHeader: Record "Purch. Inv. Header")
    begin
        with PurchInvHeader do
          FormatAddr(
            AddrArray,"Pay-to Name","Pay-to Name 2","Pay-to Contact","Pay-to Address","Pay-to Address 2",
    ...
    [Scope('Personalization')]
    procedure PurchInvShipTo(var AddrArray: array [8] of Text[90];var PurchInvHeader: Record "Purch. Inv. Header")
    begin
        with PurchInvHeader do
          FormatAddr(
            AddrArray,"Ship-to Name","Ship-to Name 2","Ship-to Contact","Ship-to Address","Ship-to Address 2",
    ...
    [Scope('Personalization')]
    procedure PurchCrMemoBuyFrom(var AddrArray: array [8] of Text[90];var PurchCrMemoHeader: Record "Purch. Cr. Memo Hdr.")
    begin
    ...
    [Scope('Personalization')]
    procedure PurchCrMemoPayTo(var AddrArray: array [8] of Text[90];var PurchCrMemoHeader: Record "Purch. Cr. Memo Hdr.")
    begin
        with PurchCrMemoHeader do
          FormatAddr(
            AddrArray,"Pay-to Name","Pay-to Name 2","Pay-to Contact","Pay-to Address","Pay-to Address 2",
    ...
    [Scope('Personalization')]
    procedure PurchCrMemoShipTo(var AddrArray: array [8] of Text[90];var PurchCrMemoHeader: Record "Purch. Cr. Memo Hdr.")
    begin
        with PurchCrMemoHeader do
          FormatAddr(
            AddrArray,"Ship-to Name","Ship-to Name 2","Ship-to Contact","Ship-to Address","Ship-to Address 2",
    ...
    [Scope('Personalization')]
    procedure PurchShptBuyFrom(var AddrArray: array [8] of Text[90];var ReturnShptHeader: Record "Return Shipment Header")
    begin
    ...
    [Scope('Personalization')]
    procedure PurchShptPayTo(var AddrArray: array [8] of Text[90];var ReturnShptHeader: Record "Return Shipment Header")
    begin
        with ReturnShptHeader do
          FormatAddr(
            AddrArray,"Pay-to Name","Pay-to Name 2","Pay-to Contact","Pay-to Address","Pay-to Address 2",
    ...
    [Scope('Personalization')]
    procedure PurchShptShipTo(var AddrArray: array [8] of Text[90];var ReturnShptHeader: Record "Return Shipment Header")
    begin
        with ReturnShptHeader do
          FormatAddr(
            AddrArray,"Ship-to Name","Ship-to Name 2","Ship-to Contact","Ship-to Address","Ship-to Address 2",
    ...
    [Scope('Personalization')]
    procedure AltAddr(var AddrArray: array [8] of Text[90];var Employee: Record Employee;var AlternativeAddr: Record "Alternative Address")
    begin
    ...
    [Scope('Personalization')]
    procedure Employee(var AddrArray: array [8] of Text[90];var Employee: Record Employee)
    begin
        with Employee do
          FormatAddr(
    ...
    [Scope('Personalization')]
    procedure EmployeeAltAddr(var AddrArray: array [8] of Text[90];var Employee: Record Employee)
    var
    ...
    [Scope('Personalization')]
    procedure VendBankAcc(var AddrArray: array [8] of Text[90];var VendBankAcc: Record "Vendor Bank Account")
    begin
        with VendBankAcc do
          FormatAddr(
            AddrArray,Name,"Name 2",Contact,Address,"Address 2",
    ...
    [Scope('Personalization')]
    procedure CustBankAcc(var AddrArray: array [8] of Text[90];var CustBankAcc: Record "Customer Bank Account")
    begin
        with CustBankAcc do
          FormatAddr(
            AddrArray,Name,"Name 2",Contact,Address,"Address 2",
    ...
    [Scope('Personalization')]
    procedure RespCenter(var AddrArray: array [8] of Text[90];var RespCenter: Record "Responsibility Center")
    begin
        with RespCenter do
          FormatAddr(
            AddrArray,Name,"Name 2",Contact,Address,"Address 2",
    ...
    [Scope('Personalization')]
    procedure TransferShptTransferFrom(var AddrArray: array [8] of Text[90];var TransShptHeader: Record "Transfer Shipment Header")
    begin
    ...
    [Scope('Personalization')]
    procedure TransferShptTransferTo(var AddrArray: array [8] of Text[90];var TransShptHeader: Record "Transfer Shipment Header")
    begin
        with TransShptHeader do
          FormatAddr(
    ...
    [Scope('Personalization')]
    procedure TransferRcptTransferFrom(var AddrArray: array [8] of Text[90];var TransRcptHeader: Record "Transfer Receipt Header")
    begin
    ...
    [Scope('Personalization')]
    procedure TransferRcptTransferTo(var AddrArray: array [8] of Text[90];var TransRcptHeader: Record "Transfer Receipt Header")
    begin
        with TransRcptHeader do
          FormatAddr(
            AddrArray,"Transfer-to Name","Transfer-to Name 2","Transfer-to Contact","Transfer-to Address","Transfer-to Address 2",
    ...
    [Scope('Personalization')]
    procedure TransferHeaderTransferFrom(var AddrArray: array [8] of Text[90];var TransHeader: Record "Transfer Header")
    begin
        with TransHeader do
          FormatAddr(
            AddrArray,
    ...
    [Scope('Personalization')]
    procedure TransferHeaderTransferTo(var AddrArray: array [8] of Text[90];var TransHeader: Record "Transfer Header")
    begin
        with TransHeader do
          FormatAddr(
            AddrArray,"Transfer-to Name","Transfer-to Name 2","Transfer-to Contact","Transfer-to Address","Transfer-to Address 2",
    ...
    [Scope('Personalization')]
    procedure ContactAddr(var AddrArray: array [8] of Text[90];var Cont: Record Contact)
    begin
        ContactAddrAlt(AddrArray,Cont,Cont.ActiveAltAddress(WorkDate),WorkDate)
    end;

    [Scope('Personalization')]
    procedure ContactAddrAlt(var AddrArray: array [8] of Text[90];var Cont: Record Contact;AltAddressCode: Code[10];ActiveDate: Date)
    var
    ...
    [Scope('Personalization')]
    procedure ServiceOrderSellto(var AddrArray: array [8] of Text[90];ServHeader: Record "Service Header")
    begin
        with ServHeader do
          FormatAddr(
    ...
    [Scope('Personalization')]
    procedure ServiceOrderShipto(var AddrArray: array [8] of Text[90];ServHeader: Record "Service Header")
    begin
        with ServHeader do
          FormatAddr(
            AddrArray,"Ship-to Name","Ship-to Name 2","Ship-to Contact","Ship-to Address","Ship-to Address 2",
    ...
    [Scope('Personalization')]
    procedure ServContractSellto(var AddrArray: array [8] of Text[90];ServContract: Record "Service Contract Header")
    begin
    ...
    [Scope('Personalization')]
    procedure ServContractShipto(var AddrArray: array [8] of Text[90];ServiceContractHeader: Record "Service Contract Header")
    begin
    ...
    [Scope('Personalization')]
    procedure ServiceInvBillTo(var AddrArray: array [8] of Text[90];var ServiceInvHeader: Record "Service Invoice Header")
    begin
    ...
    [Scope('Personalization')]
    procedure ServiceInvShipTo(var AddrArray: array [8] of Text[90];CustAddr: array [8] of Text[90];var ServiceInvHeader: Record "Service Invoice Header"): Boolean
    begin
    ...
    [Scope('Personalization')]
    procedure ServiceShptShipTo(var AddrArray: array [8] of Text[90];var ServiceShptHeader: Record "Service Shipment Header")
    begin
    ...
    [Scope('Personalization')]
    procedure ServiceShptSellTo(var AddrArray: array [8] of Text[90];var ServiceShptHeader: Record "Service Shipment Header")
    begin
        with ServiceShptHeader do
          FormatAddr(
            AddrArray,Name,"Name 2","Contact Name",Address,"Address 2",
    ...
    [Scope('Personalization')]
    procedure ServiceShptBillTo(var AddrArray: array [8] of Text[90];ShipToAddr: array [8] of Text[90];var ServiceShptHeader: Record "Service Shipment Header"): Boolean
    begin
    ...
    [Scope('Personalization')]
    procedure ServiceCrMemoBillTo(var AddrArray: array [8] of Text[90];var ServiceCrMemoHeader: Record "Service Cr.Memo Header")
    begin
    ...
    [Scope('Personalization')]
    procedure ServiceCrMemoShipTo(var AddrArray: array [8] of Text[90];CustAddr: array [8] of Text[90];var ServiceCrMemoHeader: Record "Service Cr.Memo Header"): Boolean
    begin
    ...
    [Scope('Personalization')]
    procedure ServiceHeaderSellTo(var AddrArray: array [8] of Text[90];var ServiceHeader: Record "Service Header")
    begin
    ...
    [Scope('Personalization')]
    procedure ServiceHeaderBillTo(var AddrArray: array [8] of Text[90];var ServiceHeader: Record "Service Header")
    begin
        with ServiceHeader do
          FormatAddr(
            AddrArray,"Bill-to Name","Bill-to Name 2","Bill-to Contact","Bill-to Address","Bill-to Address 2",
    ...
    [Scope('Personalization')]
    procedure ServiceHeaderShipTo(var AddrArray: array [8] of Text[90];var ServiceHeader: Record "Service Header")
    begin
        with ServiceHeader do
          FormatAddr(
            AddrArray,"Ship-to Name","Ship-to Name 2","Ship-to Contact","Ship-to Address","Ship-to Address 2",
    ...
    [Scope('Personalization')]
    procedure SalesHeaderArchBillTo(var AddrArray: array [8] of Text[90];var SalesHeaderArch: Record "Sales Header Archive")
    begin
    ...
    [Scope('Personalization')]
    procedure SalesHeaderArchShipTo(var AddrArray: array [8] of Text[90];CustAddr: array [8] of Text[90];var SalesHeaderArch: Record "Sales Header Archive"): Boolean
    var
        CountryRegion: Record "Country/Region";
        SellToCountry: Code[50];
    begin
    ...
    [Scope('Personalization')]
    procedure PurchHeaderBuyFromArch(var AddrArray: array [8] of Text[90];var PurchHeaderArch: Record "Purchase Header Archive")
    begin
    ...
    [Scope('Personalization')]
    procedure PurchHeaderPayToArch(var AddrArray: array [8] of Text[90];var PurchHeaderArch: Record "Purchase Header Archive")
    begin
        with PurchHeaderArch do
          FormatAddr(
            AddrArray,"Pay-to Name","Pay-to Name 2","Pay-to Contact","Pay-to Address","Pay-to Address 2",
    ...
    [Scope('Personalization')]
    procedure PurchHeaderShipToArch(var AddrArray: array [8] of Text[90];var PurchHeaderArch: Record "Purchase Header Archive")
    begin
        with PurchHeaderArch do
          FormatAddr(
            AddrArray,"Ship-to Name","Ship-to Name 2","Ship-to Contact","Ship-to Address","Ship-to Address 2",
    ...
    [Scope('Personalization')]
    procedure Reminder(var AddrArray: array [8] of Text[90];var ReminderHeader: Record "Reminder Header")
    begin
    ...
    [Scope('Personalization')]
    procedure IssuedReminder(var AddrArray: array [8] of Text[90];var IssuedReminderHeader: Record "Issued Reminder Header")
    begin
    ...
    [Scope('Personalization')]
    procedure FinanceChargeMemo(var AddrArray: array [8] of Text[90];var FinanceChargeMemoHeader: Record "Finance Charge Memo Header")
    begin
    ...
    [Scope('Personalization')]
    procedure IssuedFinanceChargeMemo(var AddrArray: array [8] of Text[90];var IssuedFinChargeMemoHeader: Record "Issued Fin. Charge Memo Header")
    begin
    ...
    local procedure OnAfterFormatAddress(var AddrArray: array [8] of Text[90];var Name: Text[90];var Name2: Text[90];var Contact: Text[90];var Addr: Text[50];var Addr2: Text[50];var City: Text[50];var PostCode: Code[20];var County: Text[50];var CountryCode: Code[10])
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeContactAddrAlt(var AddrArray: array [8] of Text[90];var Cont: Record Contact;AltAddressCode: Code[10];ActiveDate: Date;var Handled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeCustomer(var AddrArray: array [8] of Text[90];var Cust: Record Customer;var Handled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeFormatAddress(Country: Record "Country/Region";var AddrArray: array [8] of Text[90];var Name: Text[90];var Name2: Text[90];var Contact: Text[90];var Addr: Text[50];var Addr2: Text[50];var City: Text[50];var PostCode: Code[20];var County: Text[50];var CountryCode: Code[10];NameLineNo: Integer;Name2LineNo: Integer;AddrLineNo: Integer;Addr2LineNo: Integer;ContLineNo: Integer;PostCodeCityLineNo: Integer;CountyLineNo: Integer;CountryLineNo: Integer;var Handled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeSalesHeaderBillTo(var AddrArray: array [8] of Text[90];var SalesHeader: Record "Sales Header";var Handled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeSalesInvBillTo(var AddrArray: array [8] of Text[90];var SalesInvHeader: Record "Sales Invoice Header";var Handled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeSalesCrMemoBillTo(var AddrArray: array [8] of Text[90];var SalesCrMemoHeader: Record "Sales Cr.Memo Header";var Handled: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeVendor(var AddrArray: array [8] of Text[90];var Vendor: Record Vendor;var Handled: Boolean)
    begin
    end;
}
