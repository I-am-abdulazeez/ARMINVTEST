codeunit 1002 "Job Create-Invoice"
{
    ...
    var
        ...
        IsHandled: Boolean;
    begin
        OnBeforeCreateSalesInvoiceLines(JobPlanningLine,InvoiceNo,NewInvoice,PostingDate,CreditMemo);
        ...
        if JobPlanningLine.Find('-') then
          repeat
            if TransferLine(JobPlanningLine) then begin
              ...
              OnCreateSalesInvoiceLinesOnBeforeCreateSalesLine(JobPlanningLine,SalesHeader,SalesHeader2,NewInvoice);
        ...
        if CreateNewInvoice(JobTask,InvoicePerTask,OldJobNo,OldJobTaskNo,LastJobTask) then begin
          ...
          if TempJobPlanningLine.Find('-') then
            repeat
              ...
              OnCreateSalesInvoiceJobTaskOnBeforeCreateSalesLine(JobPlanningLine,SalesHeader,SalesHeader2);
              CreateSalesLine(JobPlanningLine);
    ...
    [IntegrationEvent(false, false)]
    local procedure OnCreateSalesInvoiceLinesOnBeforeCreateSalesLine(var JobPlanningLine: Record "Job Planning Line";SalesHeader: Record "Sales Header";SalesHeader2: Record "Sales Header";NewInvoice: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnCreateSalesInvoiceJobTaskOnBeforeCreateSalesLine(var JobPlanningLine: Record "Job Planning Line";SalesHeader: Record "Sales Header";SalesHeader2: Record "Sales Header")
    begin
    end;
}
