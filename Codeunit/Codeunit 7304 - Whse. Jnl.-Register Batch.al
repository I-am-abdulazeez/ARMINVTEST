codeunit 7304 "Whse. Jnl.-Register Batch"
{
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeRegisterLines(var WarehouseJournalLine: Record "Warehouse Journal Line";TempTrackingSpecification: Record "Tracking Specification" temporary)
    begin
    end;
