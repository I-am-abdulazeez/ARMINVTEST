codeunit 1318 "Trial Balance Mgt."
{
    ...
    procedure LoadData(var DescriptionsArr: array [9] of Text[80];var ValuesArr: array [9,2] of Decimal;var PeriodCaptionTxt: array [2] of Text;NoOfColumns: Integer)
    begin
    ...
    local procedure UpdateArrays(var DescriptionsArr: array [9] of Text[80];var ValuesArr: array [9,2] of Decimal;var PeriodCaptionTxt: array [2] of Text;NoOfColumns: Integer)
    var
        Offset: Integer;
        Counter: Integer;
        FromDate: Date;
    ...
    [Scope('Personalization')]
    procedure NextPeriod(var DescriptionsArr: array [9] of Text[80];var ValuesArr: array [9,2] of Decimal;var PeriodCaptionTxt: array [2] of Text;NoOfColumns: Integer)
    begin
        UpdatePeriod(DescriptionsArr,ValuesArr,PeriodCaptionTxt,'>=',NoOfColumns);
    end;

    [Scope('Personalization')]
    procedure PreviousPeriod(var DescriptionsArr: array [9] of Text[80];var ValuesArr: array [9,2] of Decimal;var PeriodCaptionTxt: array [2] of Text;NoOfColumns: Integer)
    begin
        UpdatePeriod(DescriptionsArr,ValuesArr,PeriodCaptionTxt,'<=',NoOfColumns);
    end;

    local procedure UpdatePeriod(var DescriptionsArr: array [9] of Text[80];var ValuesArr: array [9,2] of Decimal;var PeriodCaptionTxt: array [2] of Text;SearchText: Text[3];NoOfColumns: Integer)
    begin
