codeunit 5815 "Undo Sales Shipment Line"
{
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterCopyItemJnlLineFromSalesShpt(var ItemJournalLine: Record "Item Journal Line";SalesShipmentHeader: Record "Sales Shipment Header";SalesShipmentLine: Record "Sales Shipment Line")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeCheckSalesShptLine(var SalesShipmentLine: Record "Sales Shipment Line")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeOnRun(var SalesShipmentLine: Record "Sales Shipment Line";var IsHandled: Boolean)
    begin
    end;
