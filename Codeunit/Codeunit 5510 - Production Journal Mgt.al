codeunit 5510 "Production Journal Mgt"
{
    ...
    local procedure ReservEntryExist(ItemJnlLine2: Record "Item Journal Line";var ReservEntry: Record "Reservation Entry"): Boolean
    begin
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterSetTemplateAndBatchName(var ItemJournalTemplate: Record "Item Journal Template";var User: Text[65])
    begin
    end;
