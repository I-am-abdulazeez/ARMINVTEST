codeunit 9010 "Azure AD User Management"
{
    ...
    var
        ...
        MoreThan100UsersMsg: Label 'Number of users retrieved: %1.\Note that there might be more than %2 users defined in Office 365.', Comment='%1 and %2 are numbers, e.g. 100';
    ...
    begin
        ...
        MaxNoToRetrieve := 100; // due to a limitation in AAD
        ...
        if GuiAllowed then begin
          Window.Close;
          if i < MaxNoToRetrieve then
            Message(NoOfUsersRetrievedMsg,i)
          else
            Message(MoreThan100UsersMsg,MaxNoToRetrieve,MaxNoToRetrieve);
        end;
    end;
