codeunit 1000 "Job Calculate WIP"
{
    ...
    local procedure InsertWIPGL(AccNo: Code[20];BalAccNo: Code[20];JnlPostingDate: Date;JnlDocNo: Code[20];SourceCode: Code[10];GLAmount: Decimal;JnlDescription: Text[50];JobNo: Code[20];JobWIPGLEntryDimSetID: Integer)
    var
