codeunit 42 CaptionManagement
{
    ...
    [Scope('Personalization')]
    procedure GetSalesLineCaptionClass(var SalesLine: Record "Sales Line";FieldNumber: Integer): Text[80]
    begin
    ...
    [Scope('Personalization')]
    procedure GetPurchaseLineCaptionClass(var PurchaseLine: Record "Purchase Line";FieldNumber: Integer): Text[80]
    begin
