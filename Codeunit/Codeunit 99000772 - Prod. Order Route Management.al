codeunit 99000772 "Prod. Order Route Management"
{
    ...
    var
        ...
        SkipUpdate: Boolean;
    begin
        OnBeforeUpdateComponentsBin(FilteredProdOrderRtngLineSet,SkipUpdate,ErrorOccured);
        if SkipUpdate then
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeUpdateComponentsBin(var ProdOrderRoutingLine: Record "Prod. Order Routing Line";var SkipUpdate: Boolean;var ErrorOccured: Boolean)
    begin
    end;
}
