codeunit 6500 "Item Tracking Management"
{
    ...
    local procedure GetLotSNDataSet(ItemNo: Code[20];Variant: Code[20];LotNo: Code[50];SerialNo: Code[50];var ItemLedgEntry: Record "Item Ledger Entry"): Boolean
    begin
        ItemLedgEntry.Reset;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeCreateWhseItemTrkgForReceipt(var WhseItemTrackingLine: Record "Whse. Item Tracking Line";WhseWkshLine: Record "Whse. Worksheet Line")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeInsertSplitPostedWhseRcptLine(var TempPostedWhseRcptLine: Record "Posted Whse. Receipt Line" temporary;PostedWhseRcptLine: Record "Posted Whse. Receipt Line";WhseItemEntryRelation: Record "Whse. Item Entry Relation")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeTempWhseJnlLine2Insert(var TempWhseJnlLineTo: Record "Warehouse Journal Line" temporary;TempWhseJnlLineFrom: Record "Warehouse Journal Line" temporary;var TempSplitTrackingSpec: Record "Tracking Specification" temporary;TransferTo: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeInsertWhseItemTrkgLines(var WhseItemTrkgLine: Record "Whse. Item Tracking Line";PostedWhseReceiptLine: Record "Posted Whse. Receipt Line";WhseItemEntryRelation: Record "Whse. Item Entry Relation")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeModifyWhseItemTrkgLines(var WhseItemTrkgLine: Record "Whse. Item Tracking Line";PostedWhseReceiptLine: Record "Posted Whse. Receipt Line";WhseItemEntryRelation: Record "Whse. Item Entry Relation")
    begin
    end;
