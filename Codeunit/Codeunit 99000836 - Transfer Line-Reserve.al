codeunit 99000836 "Transfer Line-Reserve"
{
    ...
    procedure CreateReservation(var TransLine: Record "Transfer Line";Description: Text[50];ExpectedReceiptDate: Date;Quantity: Decimal;QuantityBase: Decimal;ForSerialNo: Code[50];ForLotNo: Code[50];Direction: Option Outbound,Inbound)
    var
        ShipmentDate: Date;
    begin
