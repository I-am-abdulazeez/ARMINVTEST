codeunit 57 "Document Totals"
{
    ...
    begin
        ...
        OnAfterCalculateSalesSubPageTotals(
          TotalSalesHeader,TotalSalesLine,VATAmount,InvoiceDiscountAmount,InvoiceDiscountPct);
    ...
    begin
        ...
        if Currency.Code <> TotalSalesHeader."Currency Code" then begin
          Clear(Currency);
          if TotalSalesHeader."Currency Code" = '' then
            Currency.InitRoundingPrecision
          else
            if Currency.Get(TotalSalesHeader."Currency Code") then;
        end;
    end;
    ...
    begin
        ...
        if Currency.Code <> TotalPurchaseHeader."Currency Code" then begin
          Clear(Currency);
          if TotalPurchaseHeader."Currency Code" = '' then
            Currency.InitRoundingPrecision
          else
            if Currency.Get(TotalPurchaseHeader."Currency Code") then;
        end;
    end;
    ...
    local procedure OnAfterCalculateSalesSubPageTotals(var TotalSalesHeader: Record "Sales Header";var TotalSalesLine: Record "Sales Line";var VATAmount: Decimal;var InvoiceDiscountAmount: Decimal;var InvoiceDiscountPct: Decimal)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterCalculatePurchaseSubPageTotals(var TotalPurchHeader: Record "Purchase Header";var TotalPurchLine: Record "Purchase Line";var VATAmount: Decimal;var InvoiceDiscountAmount: Decimal;var InvoiceDiscountPct: Decimal)
    begin
    end;
