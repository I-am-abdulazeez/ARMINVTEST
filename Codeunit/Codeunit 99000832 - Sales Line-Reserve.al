codeunit 99000832 "Sales Line-Reserve"
{
    ...
    procedure CreateReservation(SalesLine: Record "Sales Line";Description: Text[50];ExpectedReceiptDate: Date;Quantity: Decimal;QuantityBase: Decimal;ForSerialNo: Code[50];ForLotNo: Code[50])
    var
        ShipmentDate: Date;
        SignFactor: Integer;
    begin
    ...
    local procedure CreateBindingReservation(SalesLine: Record "Sales Line";Description: Text[50];ExpectedReceiptDate: Date;Quantity: Decimal;QuantityBase: Decimal)
    begin
