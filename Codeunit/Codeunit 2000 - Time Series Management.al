codeunit 2000 "Time Series Management"
{
    ...
    local procedure CreateTimeSeriesParameters(ForecastingPeriods: Integer;ConfidenceLevel: Integer;TimeSeriesModel: Option ARIMA,ETS,STL,"ETS+ARIMA","ETS+STL",ALL)
    begin
