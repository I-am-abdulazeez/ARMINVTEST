codeunit 367 CheckManagement
{
          ...
          CheckLedgEntry."Bal. Account Type"::Customer:
            begin
              ...
              with CustLedgEntry do begin
                ...
                if FindSet then
                  repeat
                    OnFinancialVoidCheckOnBeforePostCust(GenJnlLine2,CustLedgEntry);
          ...
          CheckLedgEntry."Bal. Account Type"::Vendor:
            begin
              ...
              with VendorLedgEntry do begin
                ...
                if FindSet then
                  repeat
                    OnFinancialVoidCheckOnBeforePostVend(GenJnlLine2,VendorLedgEntry);
                    CalcFields("Original Amount");
                    SetGenJnlLine(
                      GenJnlLine2,-"Original Amount","Currency Code",CheckLedgEntry."Document No.",
                      "Global Dimension 1 Code","Global Dimension 2 Code","Dimension Set ID");
    ...
    local procedure CalcAmountToVoid(CheckLedgEntry: Record "Check Ledger Entry"): Decimal
    var
        CheckLedgEntry2: Record "Check Ledger Entry";
    begin
    ...
    [IntegrationEvent(false, false)]
    local procedure OnFinancialVoidCheckOnBeforePostCust(var GenJournalLine: Record "Gen. Journal Line";var CustLedgerEntry: Record "Cust. Ledger Entry")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnFinancialVoidCheckOnBeforePostVend(var GenJournalLine: Record "Gen. Journal Line";var VendorLedgerEntry: Record "Vendor Ledger Entry")
    begin
    end;
}
