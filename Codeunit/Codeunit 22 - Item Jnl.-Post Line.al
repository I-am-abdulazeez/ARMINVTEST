codeunit 22 "Item Jnl.-Post Line"
{
    ...
    var
        ...
        CostAmtACY: Decimal;
    begin
        OnBeforeInitValueEntry(ValueEntry,ValueEntryNo);
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeInitValueEntry(var ValueEntry: Record "Value Entry";var ValueEntryNo: Integer)
    begin
    end;
    ...
    local procedure PrepareItem(ItemJnlLineToPost: Record "Item Journal Line")
    begin
