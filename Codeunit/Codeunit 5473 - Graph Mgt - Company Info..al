codeunit 5473 "Graph Mgt - Company Info."
{
    ...
    [Scope('Personalization')]
    procedure GetPostalAddress(PostalAddressesString: Text;AddressType: Text;var Address: Text[50];var Address2: Text[50];var City: Text[30];var County: Text[30];var CountryRegionCode: Code[10];var PostCode: Code[20])
    var
    ...
    [Scope('Personalization')]
    procedure UpdatePostalAddressJson(PostalAddressesString: Text;AddressType: Text;Address: Text[50];Address2: Text[50];City: Text[30];County: Text[30];CountryRegionCode: Code[10];PostCode: Code[20]): Text
    var
        JSONManagement: Codeunit "JSON Management";
        GraphCollectionMgtContact: Codeunit "Graph Collection Mgt - Contact";
        JObject: DotNet JObject;
