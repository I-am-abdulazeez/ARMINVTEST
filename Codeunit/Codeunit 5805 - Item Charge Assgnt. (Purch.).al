codeunit 5805 "Item Charge Assgnt. (Purch.)"
{
    ...
    [Scope('Personalization')]
    procedure InsertItemChargeAssgntWithAssignValues(FromItemChargeAssgntPurch: Record "Item Charge Assignment (Purch)";ApplToDocType: Option;FromApplToDocNo: Code[20];FromApplToDocLineNo: Integer;FromItemNo: Code[20];FromDescription: Text[50];QtyToAssign: Decimal;AmountToAssign: Decimal;var NextLineNo: Integer)
    var
    ...
    [Scope('Personalization')]
    procedure InsertItemChargeAssgntWithAssignValuesTo(FromItemChargeAssgntPurch: Record "Item Charge Assignment (Purch)";ApplToDocType: Option;FromApplToDocNo: Code[20];FromApplToDocLineNo: Integer;FromItemNo: Code[20];FromDescription: Text[50];QtyToAssign: Decimal;AmountToAssign: Decimal;var NextLineNo: Integer;var ItemChargeAssgntPurch: Record "Item Charge Assignment (Purch)")
    begin
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeInsertItemChargeAssgntWithAssignValues(var ItemChargeAssgntPurch: Record "Item Charge Assignment (Purch)")
    begin
    end;
