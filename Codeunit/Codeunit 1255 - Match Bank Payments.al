codeunit 1255 "Match Bank Payments"
{
    ...
    begin
        ...
        DirectDebitCollectionEntry.SetRange("Transaction ID",BankAccReconciliationLine."Transaction ID");
        DirectDebitCollectionEntry.SetFilter(Status,'%1|%2',
          DirectDebitCollectionEntry.Status::"File Created",DirectDebitCollectionEntry.Status::Posted);
        ...
        DirectDebitCollectionEntry.SetRange("Applies-to Entry No.",TempLedgerEntryMatchingBuffer."Entry No.");
