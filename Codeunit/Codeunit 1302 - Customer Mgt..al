codeunit 1302 "Customer Mgt."
{
    ...
    [Scope('Personalization')]
    procedure CalculateShipToBillToOptions(var ShipToOptions: Option "Default (Sell-to Address)","Alternate Shipping Address","Custom Address";var BillToOptions: Option "Default (Customer)","Another Customer";SalesHeader: Record "Sales Header")
    var
