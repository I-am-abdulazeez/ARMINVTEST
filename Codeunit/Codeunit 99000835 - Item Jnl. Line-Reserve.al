codeunit 99000835 "Item Jnl. Line-Reserve"
{
    ...
    procedure CreateReservation(var ItemJnlLine: Record "Item Journal Line";Description: Text[50];ExpectedReceiptDate: Date;Quantity: Decimal;QuantityBase: Decimal;ForSerialNo: Code[50];ForLotNo: Code[50])
    var
        ShipmentDate: Date;
    begin
