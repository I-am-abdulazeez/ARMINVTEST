codeunit 99000833 "Req. Line-Reserve"
{
    ...
    procedure CreateReservation(var ReqLine: Record "Requisition Line";Description: Text[50];ExpectedReceiptDate: Date;Quantity: Decimal;QuantityBase: Decimal;ForSerialNo: Code[50];ForLotNo: Code[50])
    var
        ShipmentDate: Date;
    begin
