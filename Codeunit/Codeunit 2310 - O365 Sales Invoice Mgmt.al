codeunit 2310 "O365 Sales Invoice Mgmt"
{
    ...
    [Scope('Personalization')]
    procedure LookupCustomerName(var SalesHeader: Record "Sales Header";Text: Text;var CustomerName: Text[50];var CustomerEmail: Text[80]): Boolean
    var
        Customer: Record Customer;
    ...
    [Scope('Personalization')]
    procedure UpdateCustomerFields(SalesHeader: Record "Sales Header";var CustomerName: Text[50];var CustomerEmail: Text[80];var IsCompanyContact: Boolean)
    begin
    ...
    [Scope('Personalization')]
    procedure ValidateCustomerName(var SalesHeader: Record "Sales Header";var CustomerName: Text[50];var CustomerEmail: Text[80])
    var
        Customer: Record Customer;
    ...
    [Scope('Personalization')]
    procedure ValidateCustomerAddress(Address: Text[50];CustomerNo: Code[20])
    var
        Customer: Record Customer;
    begin
    ...
    [Scope('Personalization')]
    procedure OnQueryCloseForSalesHeader(var SalesHeader: Record "Sales Header";ForceExit: Boolean;CustomerName: Text[50]): Boolean
    begin
        if ForceExit then
          exit(true);
    ...
    [Scope('Personalization')]
    procedure SendCustomerHasBeenBlockedNotification(CustomerName: Text[50])
    var
    ...
    [Scope('Personalization')]
    procedure CreateUnitOfMeasure(CodeToSet: Code[10];DescriptionToSet: Text[10])
    var
    ...
    [TryFunction]
    [Scope('Personalization')]
    procedure TryFindUnitOfMeasure(var TempUOM: Record "Unit of Measure" temporary;Description: Text[10])
    begin
