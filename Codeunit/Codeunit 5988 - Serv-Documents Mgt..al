codeunit 5988 "Serv-Documents Mgt."
{
    ...
    local procedure FinalizeDeleteComments()
    begin
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterServShptLineInsert(var ServiceShipmentLine: Record "Service Shipment Line";ServiceLine: Record "Service Line")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeFinalize(var ServiceHeader: Record "Service Header")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeServShptLineInsert(var ServiceShipmentLine: Record "Service Shipment Line";ServiceLine: Record "Service Line")
    begin
    end;
