codeunit 6620 "Copy Document Mgt."
{
    ...
    begin
        ...
        if FromPurchLine."Job No." <> '' then begin
        ...
        with FromSalesInvLine do
          if FindSet then
            repeat
              ...
              OnBeforeCopySalesInvLinesToBuffer(FromSalesLine,FromSalesInvLine);
              ...
              if -"Shipped Qty. Not Returned" < Abs(FromSalesLine."Quantity (Base)") then begin
                ...
                if TempSalesLineBuf."Qty. per Unit of Measure" = 0 then
                  ...
                  TempSalesLineBuf.Quantity :=
                    Round(TempSalesLineBuf."Quantity (Base)" / TempSalesLineBuf."Qty. per Unit of Measure",0.00001);
              end;
    ...
    begin
        ...
        OnAfterSetDefaultValuesToSalesLine(ToSalesLine);
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeCopySalesLine(var ToSalesHeader: Record "Sales Header";FromSalesHeader: Record "Sales Header";FromSalesLine: Record "Sales Line";RecalculateAmount: Boolean;var CopyThisLine: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeCopyPurchLine(var ToPurchHeader: Record "Purchase Header";FromPurchHeader: Record "Purchase Header";FromPurchLine: Record "Purchase Line";RecalculateAmount: Boolean;var CopyThisLine: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeCopySalesInvLinesToBuffer(var FromSalesLine: Record "Sales Line";var FromSalesInvLine: Record "Sales Invoice Line")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterCopySalesDocument(FromDocumentType: Option;FromDocumentNo: Code[20];var ToSalesHeader: Record "Sales Header";FromDocOccurenceNo: Integer;FromDocVersionNo: Integer;IncludeHeader: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterCopyPurchaseDocument(FromDocumentType: Option;FromDocumentNo: Code[20];var ToPurchaseHeader: Record "Purchase Header";FromDocOccurenceNo: Integer;FromDocVersionNo: Integer;IncludeHeader: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterSetDefaultValuesToSalesLine(var ToSalesLine: Record "Sales Line")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeInsertToSalesLine(var ToSalesLine: Record "Sales Line";FromSalesLine: Record "Sales Line";FromDocType: Option;RecalcLines: Boolean;var ToSalesHeader: Record "Sales Header")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterInsertToPurchLine(var ToPurchLine: Record "Purchase Line";var FromPurchLine: Record "Purchase Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterCopySalesHeader(ToSalesHeader: Record "Sales Header";OldSalesHeader: Record "Sales Header")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterCopyPurchaseHeader(ToPurchaseHeader: Record "Purchase Header";OldPurchaseHeader: Record "Purchase Header")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnCopyArchSalesLineOnAfterToSalesLineInsert(var ToSalesLine: Record "Sales Line";FromSalesLineArchive: Record "Sales Line Archive")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnCopyArchPurchLineOnAfterToPurchLineInsert(var ToPurchLine: Record "Purchase Line";FromPurchLineArchive: Record "Purchase Line Archive")
    begin
    end;
