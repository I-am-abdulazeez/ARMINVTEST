codeunit 1001 "Job Post-Line"
{
        ...
        with TempPurchaseLineJob do begin
          ...
          if FindSet then begin
            repeat
              ...
              OnPostPurchaseGLAccountsOnBeforeJobJnlPostLine(TempJobJournalLine,TempPurchaseLineJob);
    ...
    local procedure FindNextJobLedgEntryNo(JobPlanningLineInvoice: Record "Job Planning Line Invoice"): Integer
    var
    ...
    [IntegrationEvent(false, false)]
    local procedure OnPostPurchaseGLAccountsOnBeforeJobJnlPostLine(var JobJournalLine: Record "Job Journal Line";PurchaseLine: Record "Purchase Line")
    begin
    end;
