codeunit 925 "Assembly Header-Reserve"
{
    ...
    procedure CreateReservation(var AssemblyHeader: Record "Assembly Header";Description: Text[50];ExpectedReceiptDate: Date;Quantity: Decimal;QuantityBase: Decimal;ForSerialNo: Code[50];ForLotNo: Code[50])
    var
        ShipmentDate: Date;
    begin
    ...
    [Scope('Personalization')]
    procedure CreateReservation2(var AssemblyHeader: Record "Assembly Header";Description: Text[50];ExpectedReceiptDate: Date;Quantity: Decimal;QuantityBase: Decimal)
    begin
