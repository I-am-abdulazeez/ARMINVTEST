codeunit 5458 "Graph Collection Mgt - Contact"
{
    ...
    local procedure GetPostalAddressByType(Type: Option;var Address: Text[50];var Address2: Text[50];var City: Text[30];var County: Text[30];var CountryRegionCode: Code[10];var PostCode: Code[20])
    var
        JObject: DotNet JObject;
        value: Text;
    begin
    ...
    local procedure UpdatePostalAddress(Type: Option;Address: Text[50];Address2: Text[50];City: Text[30];County: Text[30];CountryRegionCode: Code[10];PostCode: Code[20])
    var
        JObject: DotNet JObject;
    begin
        AddressType := Type;
    ...
    [Scope('Personalization')]
    procedure UpdateHomeAddress(PostalAddressesString: Text;Address: Text[50];Address2: Text[50];City: Text[30];County: Text[30];CountryRegionCode: Code[10];PostCode: Code[20]): Text
    begin
        JSONManagement.InitializeCollection(PostalAddressesString);
    ...
    [Scope('Personalization')]
    procedure UpdateBusinessAddress(PostalAddressesString: Text;Address: Text[50];Address2: Text[50];City: Text[30];County: Text[30];CountryRegionCode: Code[10];PostCode: Code[20]): Text
    begin
        JSONManagement.InitializeCollection(PostalAddressesString);
    ...
    [Scope('Personalization')]
    procedure UpdateOtherAddress(PostalAddressesString: Text;Address: Text[50];Address2: Text[50];City: Text[30];County: Text[30];CountryRegionCode: Code[10];PostCode: Code[20]): Text
    begin
        JSONManagement.InitializeCollection(PostalAddressesString);
    ...
    [Scope('Personalization')]
    procedure GetHomeAddress(PostalAddressesString: Text;var Address: Text[50];var Address2: Text[50];var City: Text[30];var County: Text[30];var CountryRegionCode: Code[10];var PostCode: Code[20])
    begin
        JSONManagement.InitializeCollection(PostalAddressesString);
    ...
    [Scope('Personalization')]
    procedure GetBusinessAddress(PostalAddressesString: Text;var Address: Text[50];var Address2: Text[50];var City: Text[30];var County: Text[30];var CountryRegionCode: Code[10];var PostCode: Code[20])
    begin
        JSONManagement.InitializeCollection(PostalAddressesString);
    ...
    [Scope('Personalization')]
    procedure GetOtherAddress(PostalAddressesString: Text;var Address: Text[50];var Address2: Text[50];var City: Text[30];var County: Text[30];var CountryRegionCode: Code[10];var PostCode: Code[20])
    begin
        JSONManagement.InitializeCollection(PostalAddressesString);
    ...
    [Scope('Personalization')]
    procedure SplitStreet(Street: Text;var Address: Text[50];var Address2: Text[50])
    var
        CrLf: Text[2];
        NewLinePos: Integer;
    begin
