codeunit 5343 "CRM Sales Order to Sales Order"
{
    ...
    var
        ...
        CannotFindCRMAccountForOrderErr: Label 'The %2 account for %2 sales order %1 does not exist.', Comment='%1=Dynamics CRM Sales Order Name, %2 - Microsoft Dynamics CRM';
    ...
    local procedure CopyProductDescription(SalesHeader: Record "Sales Header";var SalesLine: Record "Sales Line";CRMSalesOrderProductDescription: Text)
    begin
