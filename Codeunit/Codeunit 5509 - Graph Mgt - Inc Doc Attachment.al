codeunit 5509 "Graph Mgt - Inc Doc Attachment"
{
    ...
    var
        ...
        NoPermissionErr: Label 'No permission to update a related document.', Locked=true;
    ...
    begin
        ...
        RelatedRecRef := RelatedDocument;

        if not RelatedRecRef.WritePermission then begin
          SendTraceTag('00006WH',AttachmentCategoryLbl,VERBOSITY::Error,NoPermissionErr,DATACLASSIFICATION::SystemMetadata);
          exit;
        end;
