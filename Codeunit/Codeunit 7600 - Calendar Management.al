codeunit 7600 "Calendar Management"
{
    ...
    [IntegrationEvent(false, false)]
    local procedure OnCalcDateBOCOnAfterCheckDates(NewDate: Date;Description: Text[30];var Ok: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnCalcDateBOCOnAfterGetCalendarCodes(FirstSourceType: Option Company,Customer,Vendor,Location,"Shipping Agent",Service;FirstSourceCode: Code[20];FirstAddCode: Code[20];var FirstCalcCode: Code[10];SecondSourceType: Option Company,Customer,Vendor,Location,"Shipping Agent",Service;SecondSourceCode: Code[20];SecondAddCode: Code[20];var SecondCalCode: Code[10])
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnCalcDateBOCOnAfterSetNonworking(FirstCalcCode: Code[10];SecondCalcCode: Code[10];NewDate: Date;Description: Text[30];var Nonworking: Boolean;var Nonworking2: Boolean)
    begin
    end;
}
