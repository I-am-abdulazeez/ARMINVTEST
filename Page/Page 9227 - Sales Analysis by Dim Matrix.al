page 9227 "Sales Analysis by Dim Matrix"
{
    ...
    local procedure GetFieldFilter(RequiredColumnDimOption: Option;DefaultFilter: Code[250]): Code[250]
    begin
