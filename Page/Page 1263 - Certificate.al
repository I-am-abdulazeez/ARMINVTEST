        ...
        area(content)
        {
            group(General)
            {
                ...
                field(Scope;Scope)
                {
                    ...
                    ToolTip = 'Specifies the availability of the certificate. Company gives all users in this specific company access to the certificate. User gives access to a specific user in any company. CompanyAndUser gives access to a specific user in the specific company.';
                }
            }
