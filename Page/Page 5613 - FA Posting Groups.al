            ...
            group("P&osting Gr.")
            {
                ...
                group(Allocations)
                {
                    ...
                    action(Acquisition)
                    {
                        ...
                        ToolTip = 'View or edit the FA allocation that apply to acquisitions.';
                        Visible = false;
                    }
                    action(Depreciation)
                    {
                    ...
                    action(Disposal)
                    {
                        ...
                        ToolTip = 'View or edit the FA allocation that apply to disposals.';
                        Visible = false;
                    }
                    action(Maintenance)
                    {
                    ...
                    action(BookValueGain)
                    {
                        ...
                        ToolTip = 'View or edit the FA allocations that apply to book value gains.';
                        Visible = false;
                    }
                    action(BookValueLoss)
                    {
                        ...
                        ToolTip = 'View or edit the FA allocations that apply to book value losses.';
                        Visible = false;
                    }
                }
            }
