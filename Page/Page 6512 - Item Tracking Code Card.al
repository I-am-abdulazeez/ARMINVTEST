    ...
    layout
    {
        area(content)
        {
            ...
            group("Misc.")
            {
                ...
                {
                    ApplicationArea = ItemTracking;
                    ToolTip = 'Specifies that you must manually enter an expiration date on the item tracking line.';
                }
                field("Strict Expiration Posting";"Strict Expiration Posting")
                {
                    ApplicationArea = ItemTracking;
                    ToolTip = 'Specifies that an expiration date assigned to the item tracking number as it entered inventory must be respected when it exits inventory.';
                }
            }
        }
        area(factboxes)
