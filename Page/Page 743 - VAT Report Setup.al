    ...
    layout
    {
        area(content)
        {
            ...
            group("Return Period")
            {
                ...
                field("Period Reminder Time";"Period Reminder Time")
                {
                    ApplicationArea = Basic,Suite;
                    ToolTip = 'Specifies the period in days that is used to notify about an open VAT report period with upcoming due date.';
                }
                group(Control16)
                {
                    ShowCaption = false;
