page 6510 "Item Tracking Lines"
{
    ...
    begin
        ...
        if TrackingSpecification."Lot No." <> '' then
          ...
          do begin
            ...
            if (ReservEntry1."Source Type" = DATABASE::"Transfer Line") and
               (ReservEntry1."Source Subtype" = 1)
            then
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterSetSourceSpec(var TrackingSpecification: Record "Tracking Specification";var CurrTrackingSpecification: Record "Tracking Specification";var AvailabilityDate: Date;BlockCommit: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnRegisterChangeOnAfterCreateReservEntry(var ReservEntry: Record "Reservation Entry";TrackingSpecification: Record "Tracking Specification")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnRegisterChangeOnAfterModify(var NewTrackingSpecification: Record "Tracking Specification";OldTrackingSpecification: Record "Tracking Specification")
    begin
    end;
