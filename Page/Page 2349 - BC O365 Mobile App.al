page 2349 "BC O365 Mobile App"
{
    ...
    var
        ...
        InvoicingMobileAppSettingsCategoryLbl: Label 'AL Invoicing Mobile App Settings', Comment='{LOCKED}';
        LearnMoreTelemetryTxt: Label 'Learn more link has been clicked.', Comment='{LOCKED}';
}
