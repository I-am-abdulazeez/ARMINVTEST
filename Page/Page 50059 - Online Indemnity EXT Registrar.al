        ...
        area(processing)
        {
            ...
            action(Verified)
            {
                ...
                var
                    ...
                    Statusoptions: Option Received,"ARM Registrar","External Registrar","Verification Successful","Verification Rejected",Cancelled;
                begin
                    FundAdministration.ChangeOnlineIndemnityStatusbatch(Statusoptions::"External Registrar",Statusoptions::"Verification Successful");
                end;
            }
            action(Rejected)
            {
                ...
                var
                    ...
                    Statusoptions: Option Received,"ARM Registrar","External Registrar","Verification Successful","Verification Rejected",Cancelled;
                begin
                    FundAdministration.ChangeOnlineIndemnityStatusbatch(Statusoptions::"External Registrar",Statusoptions::"Verification Rejected");
                end;
            }
