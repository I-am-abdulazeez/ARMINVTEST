page 50083 "Unit Transfer ARM  Reg"
{
    CardPageID = "Unit Transfer Card";
    DeleteAllowed = false;
    PageType = List;
    SourceTable = "Fund Transfer";
    SourceTableView = WHERE("Fund Transfer Status"=CONST("ARM Registrar"));
        ...
        area(processing)
        {
            ...
            action(Verify)
            {
                ...
                var
                    ...
                    Statusoptions: Option Received,"ARM Registrar","External Registrar",Rejected,Verified,Posted;
                begin
                    FundAdministration.ChangeFundTransferStatusBatch(Statusoptions::"ARM Registrar",Statusoptions::"External Registrar");
                end;
            }
            ...
            action("Update Prices")
            {
                ...
                begin
                    ...
                    UnitTransfer.SetRange("Fund Transfer Status",UnitTransfer."Fund Transfer Status"::"ARM Registrar");
