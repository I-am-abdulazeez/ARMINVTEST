page 50072 "Redemptions External Registrar"
{
    CardPageID = "Redemption Card";
    DeleteAllowed = false;
    PageType = List;
    SourceTable = Redemption;
    SourceTableView = WHERE("Redemption Status"=CONST("External Registrar"));
    ...
    actions
    {
        area(processing)
        {
            action("Select All")
            {
                ...
                begin
                    FundAdministration.SelectALLRedemption(Statusoptions::"External Registrar");
                end;
            }
            action("Un Select All")
            {
                ...
                var
                    ...
                    Statusoptions: Option Received,"ARM Registrar","External Registrar",Rejected,Verified,Posted;
                begin
                    FundAdministration.UnSelectALLRedemption(Statusoptions::"External Registrar");
                end;
            }
            action(Verified)
            {
                ...
                var
                    ...
                    Statusoptions: Option Received,"ARM Registrar","External Registrar",Rejected,Verified,Posted;
                begin
                    FundAdministration.ChangeRedemptionStatusBatch(Statusoptions::"External Registrar",Statusoptions::Verified);
                end;
            }
            action(Rejected)
            {
                ...
                var
                    ...
                    Statusoptions: Option Received,"ARM Registrar","External Registrar",Rejected,Verified,Posted;
                begin
                    FundAdministration.ChangeRedemptionStatusBatch(Statusoptions::"External Registrar",Statusoptions::Rejected);
                end;
            }
