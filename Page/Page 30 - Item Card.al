    ...
    layout
    {
        area(content)
        {
            ...
            group("Prices & Sales")
            {
                ...
                {
                    ApplicationArea = Basic,Suite;
                    ToolTip = 'Specifies that the item cannot be entered on sales documents and journals.';
                }
            ...
            group(Replenishment)
            {
                ...
                group(Purchase)
                {
                    ...
                    {
                        ApplicationArea = Basic,Suite;
                        ToolTip = 'Specifies that the item cannot be entered on purchase documents and journals.';
                    }
                }
                group(Production)
                {
            ...
            group(Planning)
            {
                ...
                field(Reserve;Reserve)
                {
                    ...
                    Importance = Additional;
                    ToolTip = 'Specifies whether the program will allow reservations to be made for this item.';
                }
