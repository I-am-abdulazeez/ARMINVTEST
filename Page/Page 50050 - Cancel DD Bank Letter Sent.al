page 50050 "Cancel DD Bank Letter Sent"
{
    ...
    SourceTableView = WHERE(Status=CONST("Update Direct Debit"),
                            "Request Type"=CONST(Cancellation),
                            "Cancellation Channel"=CONST(Bank));
    ...
    actions
    {
        area(processing)
        {
            action("Select All")
            {
                ...
                begin
                    FundAdministration.SelectALLDirectDebitCancel(Statusoptions::"Sent letter to Bank");
                end;
            }
            action("Un Select All")
            {
                ...
                var
                    ...
                    Statusoptions: Option Received,"ARM Registrar","Logged on Bank Platform","Approved By Bank","Rejected By Bank",Cancelled,"Batch ID Generated","Mandate Cancelled","Update Direct Debit","Sent letter to Bank","Received Response From Bank";
                begin
                    FundAdministration.UnSelectALLDirectDebitCancel(Statusoptions::"Sent letter to Bank");
                end;
            }
            action("Response Received From bank")
            {
                ...
                var
                    ...
                    Statusoptions: Option Received,"ARM Registrar","Logged on Bank Platform","Approved By Bank","Rejected By Bank",Cancelled,"Batch ID Generated","Mandate Cancelled","Update Direct Debit","Sent letter to Bank","Received Response From Bank";
                begin
                    FundAdministration.ChangeDirectDebitCancelStatusBatch(Statusoptions::"Sent letter to Bank",Statusoptions::"Received Response From Bank");
                end;
            }
