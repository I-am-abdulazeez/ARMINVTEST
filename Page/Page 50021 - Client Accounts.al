page 50021 "Client Accounts"
{
    CardPageID = "Client Account Card";
    DeleteAllowed = false;
    Editable = false;
    PageType = List;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Last update Source";"Last update Source")
                {
                    Caption = 'Source';
                    Enabled = false;
                }
    ...
    actions
    {
        area(processing)
        {
            action("Update Nominee Client")
            {
                Image = UpdateDescription;
                Promoted = true;
                PromotedCategory = Process;
                PromotedIsBig = true;
                RunObject = XMLport UpdateNomineeClients;
            }
        }
    }
