        ...
        area(content)
        {
            ...
            repeater(Group)
            {
                ...
                field("Security Filter";"Security Filter")
                {
                    ...
                    Style = Strong;
                    StyleExpr = ZeroObjStyleExpr;
                    ToolTip = 'Specifies a securiry filter that applies to this permission set to limit the access that this permission set has to the data contained in this table.';
