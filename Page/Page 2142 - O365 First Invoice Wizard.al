    ...
    layout
    {
        area(content)
        {
            group(Control96)
            {
                ...
                field(MediaResourcesFirstInv1;MediaResourcesFirstInv1."Media Reference")
                {
            ...
            group(Control98)
            {
                ...
                field(MediaResourcesFirstInv2;MediaResourcesFirstInv2."Media Reference")
                {
                    ApplicationArea = Basic,Suite,Invoicing;
                    Editable = false;
                    ShowCaption = false;
            ...
            group(Control42)
            {
                ...
                field(MediaResourcesFirstInv3;MediaResourcesFirstInv3."Media Reference")
                {
                    ApplicationArea = Basic,Suite,Invoicing;
                    Editable = false;
                    ShowCaption = false;
