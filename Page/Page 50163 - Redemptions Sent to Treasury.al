page 50163 "Redemptions Sent to Treasury"
{
    ...
    actions
    {
        area(processing)
        {
            ...
            action("Payment Schedule")
            {
                ...
                trigger OnAction()
                begin
                    Clear(ExportPaidPaymentSchedule);
                    ExportPaidPaymentSchedule.Run;
                end;
            }
        }
    }
    ...
    var
        ExportPaidPaymentSchedule: Report "Export Paid Payment Schedule";
}
